      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">     
              <button type="button" class="btn btn-block btn-success btn-sm" data-toggle="modal" data-target="#modal-add">Add Operator</button>    
          </div>
        </div>
        <div class="card-body">       
        ...
        <table id="example1"  class="table table-striped">
                  ...
                  <tbody>    
                      ...
                      foreach($districtData as $list): 
                        ...
                        $customers = $builder->where("created_by_user",$list['u_id'])
                                              ->countAllResults(); 
                      ...
                      <tr>                      
                            ...
                            <td class="text-center"><?php echo $customers;  ?><br>                          
                                  <a href="<?= base_url('admin/customers/'.$list['u_id']) ?>" class="btn btn-info btn-xs" >VIEW</a>                          
                            </td>
                              <?php } else { ?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">                
              ...
              <!-- form start -->
              <form role="form" action="<?= base_url('admin/operator/create') ?>" method="post">
                <div class="card-body">
...
<div class="modal fade" id="modal-update">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">                
              ...
              <!-- form start -->
              <form role="form" action="<?= base_url('admin/operator/update') ?>" method="post">
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-light">
            ...
            <div class="modal-body">                
                <p>Are You sure to <strong>Delete</strong> the operator <strong><span id = "delName"></span></strong>   ?</p>                            
                <form action="<?php echo base_url('admin/operator/delete') ?>" method="post">                    
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-light">
            ...
            <div class="modal-body">                
                ...
                <form action="<?php echo base_url('admin/operator/password') ?>" method="post">                    
